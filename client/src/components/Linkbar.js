...
class Linkbar extends Component {
  ...
  render() {
    ...
    const styleNone = (this.props.history.location.pathname === ('/items' || '/')) ? '' : 'none';
    ...
    return (
      ...
      <header className='navbar'>
        ...
        <div className="nav-menu">
          ...
          <li key="2" style={{display:styleNone}}><Link activeClass="active" to="products" spy={true} smooth={true} offset={50} duration={500} delay={200}>Products</Link></li>
