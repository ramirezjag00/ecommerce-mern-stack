...
class Cart extends Component {
  ...
  ...currentItemToDelete.slice(indexToDelete + 1)]
	...
	renderEmpty() {
		return (<h1 style={{ textAlign:'center', marginTop:'10vh', marginBottom:'10vh'}}><p style={{color:'#303030'}}>NO ITEMS FOUND INSIDE THE CART :(</p> <Link to="/items">CONTINUE SHOPPING</Link></h1>)
	}
	renderCart(){
			...
			<Panel bsStyle="primary">
				...
				<Panel.Body>
					...
					<Modal show={this.state.show} onHide={this.handleClose.bind(this)}>
			          ...
			          <Modal.Footer>
			          	<Col xs={6}>
			          		<h6>Total Php:{this.props.totalAmount}</h6>
			          	</Col>
